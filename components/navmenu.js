...
export default function NavMenu () {
   return (
      <nav className="container sticky top-0 bg-white flex  items-center justify-between p-3 mx-auto lg:justify-between xl:px-0">
         <Disclosure>
          {({ open }) => (
        ...
        <div className="flex flex-wrap items-center justify-between w-full lg:w-auto mx-100">
          ...
          <Disclosure.Button
                ...
                <Disclosure.Panel className="flex flex-wrap w-full my-5 mx-5 lg:hidden">
